...
```bash
mkdir -p sh-auth/src/main/java/com/wkclz/auth/{config,context,enums,exception,bean,contract/{auth,authz,infra},filter}
...
**文件：**
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Principal.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Subject.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Credential.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/AuthRequest.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/AuthResult.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/AuthToken.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Session.java`
...
```bash
git add sh-auth/src/main/java/com/wkclz/auth/bean/Principal.java sh-auth/src/main/java/com/wkclz/auth/bean/Subject.java sh-auth/src/main/java/com/wkclz/auth/bean/Credential.java sh-auth/src/main/java/com/wkclz/auth/bean/AuthRequest.java sh-auth/src/main/java/com/wkclz/auth/bean/AuthResult.java sh-auth/src/main/java/com/wkclz/auth/bean/AuthToken.java sh-auth/src/main/java/com/wkclz/auth/bean/Session.java
...
**文件：**
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Captcha.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/MfaChallenge.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/ModelPermission.java` → 注意：这是 `Permission.java`（但 Permission 与 java.security.Permission 冲突，使用全限定名或重命名）
...
```bash
git add sh-auth/src/main/java/com/wkclz/auth/bean/Captcha.java sh-auth/src/main/java/com/wkclz/auth/bean/MfaChallenge.java sh-auth/src/main/java/com/wkclz/auth/bean/AuthPermission.java
...
**文件：**
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/Role.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/MenuNode.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/ApiResource.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/DataScope.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/FieldPermission.java`
...
```bash
git add sh-auth/src/main/java/com/wkclz/auth/bean/Role.java sh-auth/src/main/java/com/wkclz/auth/bean/MenuNode.java sh-auth/src/main/java/com/wkclz/auth/bean/ApiResource.java sh-auth/src/main/java/com/wkclz/auth/bean/DataScope.java sh-auth/src/main/java/com/wkclz/auth/bean/FieldPermission.java
...
**文件：**
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/SubjectRole.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/RoleDataScope.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/ApiField.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/LoginRecord.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/RequestRecord.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/SecurityHeaders.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/AuthMetadata.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/SubjectAuthorization.java`
- 创建：`sh-auth/src/main/java/com/wkclz/auth/bean/ResolvedAuthorization.java`
...
```bash
git add sh-auth/src/main/java/com/wkclz/auth/bean/SubjectRole.java sh-auth/src/main/java/com/wkclz/auth/bean/RoleDataScope.java sh-auth/src/main/java/com/wkclz/auth/bean/ApiField.java sh-auth/src/main/java/com/wkclz/auth/bean/LoginRecord.java sh-auth/src/main/java/com/wkclz/auth/bean/RequestRecord.java sh-auth/src/main/java/com/wkclz/auth/bean/SecurityHeaders.java sh-auth/src/main/java/com/wkclz/auth/bean/AuthMetadata.java sh-auth/src/main/java/com/wkclz/auth/bean/SubjectAuthorization.java sh-auth/src/main/java/com/wkclz/auth/bean/ResolvedAuthorization.java
...
### 任务 16：过滤器 — RequestRecordFilter

**文件：**
- 创建：`sh-auth/src/main/java/com/wkclz/auth/filter/RequestRecordFilter.java`

- [ ] **步骤 1：编写 RequestRecordFilter**
...
public class RequestRecordFilter extends OncePerRequestFilter {
    ...
    private RequestRecord buildRecord(HttpServletRequest request, ContentCachingResponseWrapper response,
        ...
        com.wkclz.auth.bean.Principal principal = SecurityContext.getPrincipal();
        if (principal != null) {
...
```bash
git add sh-auth/src/main/java/com/wkclz/auth/filter/RequestRecordFilter.java
git commit -m "feat: add RequestRecordFilter with SecurityContext.clear() in finally"
```
...
public class ShAuthAutoConfiguration {
    ...
    @Bean
    public FilterRegistrationBean<RequestRecordFilter> requestLogFilterReg(List<RequestLogger> requestLoggers) {
...
预期：BUILD SUCCESS，`sh-auth/target/sh-auth-5.0.1-SNAPSHOT.jar` 生成。
...
```bash
jar tf sh-auth/target/sh-auth-5.0.1-SNAPSHOT.jar | grep "com/wkclz/sh/auth" | head -30
```
...
```bash
jar tf sh-auth/target/sh-auth-5.0.1-SNAPSHOT.jar | grep "AutoConfiguration.imports"
```
...
7. **过滤器 (6/6)**：RequestWrapper, RequestRecord, SecurityHeader, Authentication, Authorization + FilterOrder 常量
8. **SecurityContext**：含 clear() 方法，RequestRecordFilter.finally 中调用
