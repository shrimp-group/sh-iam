...
| **SES-03** | Token 生成    | JWT HS256 签名，claims 仅含 userCode/username/nickname（最小信息集），TTL 可配置，默认 24h                                                                                          | 现状 #9, #10, #39       |
| **SES-04** | Token 验证    | JWT 签名 + 过期校验，解析出 userCode/username/nickname                                                                                                                     | 现状 #9, #10            |
