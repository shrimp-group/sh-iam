...
1. 将 templates/common/skills/ 下的 13 个 skill 目录复制到目标项目的 .trae/skills/ 目录
2. 生成 .trae/mcp.json 配置文件（从模板或默认配置）
3. 向用户说明 skill 的使用方式：
    - 核心流水线：/grill → /plan → /plan-to-tasks → /write-code → /check-work
    - 辅助技能：/zoom-out、/grill-me、/handoff
    - 编码规范：coding-skill、request-analysis、code-review、expert-reviewer
4. 引导用户安装推荐的 MCP Server（参见 docs/skill-setup.md）
